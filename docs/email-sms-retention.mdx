---
title: "📧 Email/SMS/Retention Team"
sidebarTitle: "Email/SMS/Retention Team"
description: "Below is a video walkthrough that details how Email, SMS, and Retention Teams can effectively use Northbeam to evaluate their impact and make decisions around lifecycle marketing."
---

Please note:

* It is important for Retention Teams to understand this logic as it is materially different than the rest (Email/SMS).
* Clicks-Only & Clicks + Modeled Views may discredit Email/SMS.

# Walkthrough Video

<Frame>
  <iframe src="https://www.loom.com/embed/d5db18de1c284a29b9403708a95029ea?sid=d5d93a34-a33d-4de7-bf51-6865cd8b36fb" width="100%" height="450" allowfullscreen></iframe>
</Frame>
...
<Tip>
  ...
  * **Attribution Model**:
  * Last Non-Direct Touch, *if you are comparing performance (also for decision-making as it gives the most credit to decision-making*, OR
  ...
  * **Breakdown By**: Category and your designated [Labels](/docs/manage-breakdowns), specifically for Email & SMS.
</Tip>

<Tip>
  You can use the [Model Comparison feature](https://dashboard.northbeam.io/model-comparison) to compare 2 Attribution Models: Last Non-Direct Touch and Clicks-Only.
  ...
  **Northbeam's** models are designed to **de-weight lower-funnel channels** (like Email and SMS) in favor of top-funnel touchpoints when appropriate.
  ...
  You can learn more about [Norhtbeam's Model Comparison here](/docs/what-is-northbeam-model-comparison-tool).
</Tip>
...
* For cleaner reporting, set up UTM rules to segment Email/SMS traffic into Campaigns vs. Flows
  * Review and refine this [Label](/docs/manage-breakdowns) by regularly ensuring accurate grouping.
