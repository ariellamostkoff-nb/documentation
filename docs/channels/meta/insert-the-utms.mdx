...
<Frame caption="Build a URL Parameter > Custom Parameters">
  <img src="/images/readme/4ba9e613-Screenshot_2025-05-13_at_9.33.31_AM.png" alt="Build a URL Parameter > Custom Parameters" />
</Frame>
...
<Frame>
  <img src="/images/readme/a82db463-Screenshot_2025-04-10_at_11.01.14_PM.png" alt="" />
</Frame>
...
<Frame caption="Click the first 'Network' request, then look in the 'Payload'">
  <img src="/images/readme/2e13d764-Screenshot_2025-04-10_at_11.06.31_PM.png" alt="Click the first 'Network' request, then look in the 'Payload'" />
</Frame>
...
<Frame caption="Note: It's completely normal to see multiple requests. Look for the one with 'pv' in the Payload.">
  <img src="/images/readme/12aa2af0-Screenshot_2025-04-11_at_11.44.04_AM.png" alt="Note: It's completely normal to see multiple requests" />
</Frame>
