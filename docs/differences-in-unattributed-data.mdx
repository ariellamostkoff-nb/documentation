...
sidebarTitle: "Unattributed data"
...
2. **Pixel Data** - This is data collected through our tracking pixels placed on your website ([Northbeam Pixel](/docs/add-pixel) and [Purchase Events](/docs/purchase-pixel))
...
<Warning>
  Exception: We exclusively use Pixel Data for [Custom Goals](/docs/setting-up-custom-goals)
</Warning>
...
<Warning>
  Any order that does not trigger our [Northbeam Pixel](/docs/add-pixel) or [Purchase Pixel](/docs/purchase-pixel) will be Unattributed.
</Warning>
...
Learn more about our [Purchase Pixel](/docs/purchase-pixel).
