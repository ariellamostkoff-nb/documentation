...
sidebarTitle: "Multiple stores & regions"
...
| Multiple domains, need first-party tracking         | One dashboard per domain (Option 2A)                          |
| Multiple domains, need first-party + separated data | One dashboard per domain (Option 2A)                          |

***

## What's Next

* **Single dashboard setup** → See [Welcome to Northbeam](/docs/what-to-expect-during-implementation)
