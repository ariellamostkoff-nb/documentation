...
To start using the Data Export API, you'll need an API key. You can generate one by following the instructions in the [Authentication](/docs/orders-api) guide, which provides more information on how to generate an API key.
